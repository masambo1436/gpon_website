...
@section('fcontent')
    <main>
        ...
        @else
            ...
            <section class="page-title-area" style="background-image:url(/uploads/2023annualreport.jpg);">
            <div class="container">
                <div class="row">
                    <div class="col-xl-6 offset-xl-3">
                        <div class="page-title-wrapper text-center pt-32">
                        ...
                        <div class="details-left-area pb-24">
                            ...
                            <div class="cases-feature mb-[3px]">
                                ...
                                <div class="row">
                                    ...
                                    <div class="cases-meta d-sm-flex justify-content-between mt-5 mb-7">
                                       
                                        <div class="cases-btn mb-2 d-xl-inline-block ">
