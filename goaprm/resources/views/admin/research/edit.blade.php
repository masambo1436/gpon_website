...
@include('includes.messages')
         <form action="{{route('re.update',['id' => $post->id])}}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                    <label for="featured_image">Document</label>
                    <input type="file" name="file" id="featured_image" class="form-control" accept=".pdf,.doc,.docx">
                    </div>
                  
       <div class="form-group">
          <a href="{{route('re.index')}}" class="btn btn-secondary">Cancel</a>
